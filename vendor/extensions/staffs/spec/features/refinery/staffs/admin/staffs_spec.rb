...
describe Refinery do
  describe "Staffs" do
    describe "Admin" do
      describe "staffs", type: :feature do
        refinery_login
        ...
        describe "create" do
          ...
          context "valid data" do
            it "should succeed" do
              ...
              expect { click_button "Save" }.to change(Refinery::Staffs::Staff, :count).from(0).to(1)
          ...
          context "invalid data" do
            it "should fail" do
              expect { click_button "Save" }.not_to change(Refinery::Staffs::Staff, :count)
        ...
        describe "destroy" do
          ...
          it "should succeed" do
            ...
            expect(Refinery::Staffs::Staff.count).to eq(0)
          end
        end
